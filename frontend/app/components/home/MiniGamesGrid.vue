      ...
      <div class="mb-8">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div class="flex items-center justify-end gap-2">
            <NuxtLink class="text-gray-400 hover:text-white text-xs px-3 py-1.5 border border-gray-700 rounded transition-colors" :to="routes[active]">Show all</NuxtLink>
            <button aria-label="Previous games" class="text-gray-400 hover:text-white p-1.5 border border-gray-700 rounded transition-colors" @click="moveRail(-1)">
            ...
            <button aria-label="Next games" class="text-gray-400 hover:text-white p-1.5 border border-gray-700 rounded transition-colors" @click="moveRail(1)">
