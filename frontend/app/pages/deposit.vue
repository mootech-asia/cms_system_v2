...
.transfer .pill{display:block;width:max-content;margin:0 auto 24px;padding:10px 22px;border-radius:999px;background:#0a1526;color:#fff;font-weight:700;font-size:15px}
...
.transfer .complete{display:flex;align-items:center;justify-content:center;width:100%;height:56px;margin-top:8px;border:0;border-radius:10px;background:#0a1526;cursor:pointer}
.transfer .complete span{background:linear-gradient(90deg,#ff4d9d,#ff8a3d,#ffb43d);-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent;font-weight:800;font-size:16px}
</style>
