...
(function () {
  ...
  function ensureStyles() {
    ...
    style.textContent = `
      ...
      .promotion-detail-heading{display:inline-flex;align-items:center;margin:0;color:#f9fafb;font-size:30px;font-weight:900;line-height:1}
      ...
      .promotion-detail-logo{height:42px;object-fit:contain;mix-blend-mode:lighten}.promotion-detail-kicker{margin:0;color:#98E7D2;font-size:14px;font-weight:900;letter-spacing:.22em;text-transform:uppercase}.promotion-detail-title{margin:8px 0 0;font-size:50px;font-weight:1000;line-height:1.08;background:linear-gradient(90deg,#CBE8E4,#98E7D2);-webkit-background-clip:text;background-clip:text;color:transparent}
      .promotion-detail-subtitle{margin:12px 0 0;color:#f9fafb;font-size:22px;font-weight:800}.promotion-detail-offers{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:18px;width:100%;margin-top:2px}.promotion-detail-offer{position:relative;border:1px solid rgba(152,231,210,.24);border-radius:8px;background:#0f1419;padding:28px 18px 22px;box-shadow:inset 0 1px 0 rgba(255,255,255,.03)}
      .promotion-detail-rank{position:absolute;top:-15px;left:50%;transform:translateX(-50%);width:34px;height:28px;border-radius:999px;display:flex;align-items:center;justify-content:center;background:linear-gradient(90deg,#CBE8E4,#98E7D2);color:#0f1419;font-size:14px;font-weight:1000;box-shadow:0 8px 18px rgba(0,0,0,.28)}
      .promotion-detail-offer h4{margin:0 0 10px;color:#CBE8E4;font-size:19px;font-weight:900}.promotion-detail-offer strong{display:block;color:#f9fafb;font-size:30px;line-height:1}.promotion-detail-offer span{display:block;margin-top:10px;color:#9ca3af;font-size:14px;font-weight:700}
