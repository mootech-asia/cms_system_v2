...
(function () {
  ...
  function ensureStyles() {
    ...
    style.textContent = `
      ...
      .promotion-detail-heading{display:inline-flex;align-items:center;margin:0;color:#f9fafb;font-size:30px;font-weight:800;line-height:1}
      ...
      .promotion-detail-offer h4{margin:0 0 10px;color:#CBE8E4;font-size:19px;font-weight:800}.promotion-detail-offer strong{display:block;color:#f9fafb;font-size:30px;line-height:1}.promotion-detail-offer span{display:block;margin-top:10px;color:#9ca3af;font-size:14px;font-weight:700}
